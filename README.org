...
key/value store. It's the second complete OTP app detailed in the book.

For an improved version with a =gen-event=-based logging system see the
[[https://github.com/yurrriq/simple_cache/tree/chapter_07][chapter_07 branch]].
