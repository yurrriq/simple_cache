...
** Introduction
This OTP application that provides a key/value store is based on [[https://github.com/yurrriq/simple_cache/tree/chapter_06][the Chapter 6
version]], but features an added =gen-event=-based logging system.
